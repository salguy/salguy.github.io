---
layout: default
title: 살가이 프로젝트 문서 개요
nav_order: 2
permalink: /documents/overview/
---
...
- 스케줄러에 기반하여 복약 알림을 루틴화
  ...
  **ㅁ. 결과 기록**  
   ...
   LLM 응답을 파싱 후 복약 시점을 DB에 저장.
   날짜별, 시간별 복약 기록이 시각화되어 관리자/보호자가 애플리케이션(**개발예정**)에서 확인 가능하도록 구현 예정
...
- [👋 Hello World! (문서 탐색 가이드)](/)  
- [🧑‍💻 개발 가이드](documents/developments)  
- [🙋‍♀️ 서비스 가이드](documents/user-guide)  